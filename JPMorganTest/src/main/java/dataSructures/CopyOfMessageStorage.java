...
public class CopyOfMessageStorage{
	...
	private HashMap<Long, LinkedBlockingQueue<Message>> messageStorage;

	public CopyOfMessageStorage() {
		this.messageStorage = new HashMap<Long, LinkedBlockingQueue<Message>>();
	}
	 ...
	 */
	public HashMap<Long, LinkedBlockingQueue<Message>> getMessageStorage() {
	 ...
	 */
	public void setMessageStorage(HashMap<Long, LinkedBlockingQueue<Message>> messageStorage) {

...
/**
 * This class is no longer used, superseded by the use of the java.util.concurrent.BlockingQueue, however I left it here part of the submission.
 */
 ...
 * 
 * I was torn to either use Message (more readable) as the type or E Generic Object (more generic), I decided to make it more readable
